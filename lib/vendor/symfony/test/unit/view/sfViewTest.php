...
$context->getRequest()->setFormat('jscript', 'application/x-javascript');
$context->getRequest()->setRequestFormat('jscript');
...
$t->is($view->getExtension(), '.jscript.php', '->initialize() uses the format to configure the view');
$context = sfContext::getInstance(array('request' => 'sfWebRequest', 'response' => 'sfWebResponse'), true);
