...
class MyWidget extends sfWidgetForm
{
  ...
  {
    return array('/path/to/a/'.$this->getOption('name').'.jscript', '/path/to/foo.jscript');
  }
...
$t->is($w->getJavaScripts(), array('/path/to/a/foo.jscript', '/path/to/foo.jscript', '/path/to/a/bar.jscript'), '->getJavaScripts() returns an array of stylesheets');
