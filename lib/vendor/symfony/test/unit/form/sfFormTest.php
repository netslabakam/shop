...
class MyWidget extends sfWidgetForm
{
  ...
  {
    return array('/path/to/a/'.$this->getOption('name').'.jscript');
  }
...
$t->is($f->getJavaScripts(), array('/path/to/a/foo.jscript', '/path/to/a/bar.jscript'), '->getJavaScripts() returns the stylesheets of all widgets');
