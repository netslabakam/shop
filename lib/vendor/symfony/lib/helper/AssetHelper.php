 ...
 *    => /jscript/myscript.jscript
 * </code>
 *
 * <b>Note:</b> The asset name can be supplied as a...
 * - full path, like "/my_js/myscript.css"
 * - file name, like "myscript.jscript", that gets expanded to "/jscript/myscript.jscript"
 * - file name without extension, like "myscript", that gets expanded to "/jscript/myscript.jscript"
 *
...
{
  return _compute_public_path($source, sfConfig::get('sf_web_js_dir_name', 'jscript'), 'jscript', $absolute);
}
 ...
 *    => <script language="JavaScript" type="text/javascript" src="/jscript/xmlhr.jscript"></script>
 *  echo javascript_include_tag('common.javascript', '/elsewhere/cools');
 *    => <script language="JavaScript" type="text/javascript" src="/jscript/common.javascript"></script>
 *       <script language="JavaScript" type="text/javascript" src="/elsewhere/cools.jscript"></script>
 * </code>
 *
...
function dynamic_javascript_include_tag($uri, $absolute = false, $options = array())
{
  ...
  return javascript_include_tag(_dynamic_path($uri, 'jscript', $absolute), $options);
}
...
function use_dynamic_javascript($js, $position = '', $options = array())
{
  ...
  return use_javascript(_dynamic_path($js, 'jscript'), $position, $options);
}
 ...
 *   {
 *     return array('/path/to/a/file.jscript');
 *   }
 * }
 * </code>
 *
