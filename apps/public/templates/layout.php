        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    <ul class="navbar-nav mr-auto smoth-scroll">
                        <li>
                            <a href="<?php echo url_for('@shop_new') ?>" class="nav-link waves-effect waves-light">Post new</a>
                        </li>
                        <li>
                            <a class="nav-link waves-effect waves-light">Aksessuari</a>
                        </li>
                        <li>
                            <a class="nav-link waves-effect waves-light"<?php echo link_to('Registr', 'sf_guard_user_new') ?>></a>
                        </li>
                        <li>
                            <a class="nav-link waves-effect waves-light"<?php echo link_to('Users', 'users') ?>> </a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav nav-flex-item">
                        <?php if ($sf_user->isAuthenticated()): ?>
                            <li>
                                <a class="nav-link waves-effect waves-light"<?php echo link_to('LogOut', 'sf_guard_signout') ?>></a>
                            </li>
                        <?php endif ?>
                        <li>
                            <?php if (!$sf_user->isAuthenticated()): ?>
                            <a class="nav-link waves-effect waves-light"<?php echo link_to('LogIn', 'sf_guard_signin') ?>></a>
                        </li>
                        <?php endif ?>
                        <li class="nav-item">
